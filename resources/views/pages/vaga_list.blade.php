...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <div class="mb-3">
                <a class="btn btn-primary" href="{{ route('vaga.showForm') }}" role="button"
                    title="Cadastrar nova vaga">Adicionar</a>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 ">
                    ...
                    <form action="{{ route('vaga.busca') }}" method="GET">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('vaga.editar', $v->id) }}" title="Editar"><i
                                        class="fas fa-edit"></i></a>

                                <a href="{{ route('vaga.deletar', $v->id) }}" title="Excluir"><i
